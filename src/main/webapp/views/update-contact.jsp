...
%>
	<form  style="color:darkblue;background-color:powderblue; margin-top: -50px" class="ftco-section" method="get" action="/contact">
		<div  class="container">
			<!-- <div class="row justify-content-center"> -->
				<!-- <div class="col-md-7 col-lg-5"> -->
					<div class="login-wrap p-5 p-md-10" style="color:darkblue;background-color:aliceblue;" >
						<div class=" d-flex align-items-center justify-content-center">
							  <svg width="100px" height="100px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"><path transform="translate(-2.4, -2.4), scale(1.7999999999999998)" fill="#7ed0ec" d="M9.166.33a2.25 2.25 0 00-2.332 0l-5.25 3.182A2.25 2.25 0 00.5 5.436v5.128a2.25 2.25 0 001.084 1.924l5.25 3.182a2.25 2.25 0 002.332 0l5.25-3.182a2.25 2.25 0 001.084-1.924V5.436a2.25 2.25 0 00-1.084-1.924L9.166.33z" strokewidth="0"></path></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M13 3H7C5.89543 3 5 3.89543 5 5V10M13 3L19 9M13 3V8C13 8.55228 13.4477 9 14 9H19M19 9V19C19 20.1046 18.1046 21 17 21H10C7.79086 21 6 19.2091 6 17V17C6 14.7909 7.79086 13 10 13H13M13 13L10 10M13 13L10 16" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
		      	        </div>
		      	        <strong><h3 style="font-weight:bold" class="text-center">Update Contact</h3></strong>

                Enter Id :

	           <div class="form-group d-flex">
	             <input type="number" name="id" class="form-control rounded-left" placeholder="Search Id ..." required ${mode}>
	           </div>
							<div style="display:flex" class="form-group">
								<button type="submit" style="flex:2; ; margin:10px" class="btn btn-primary rounded submit px-3">Submit</button>
							</div>
	                </div>	         
				<!-- </div> -->
			<!-- </div> -->
...
%>
	<form  style="color:darkblue;background-color:powderblue; margin-top: -50px" class="ftco-section" method="post" action="/contact/update">
		<div  class="container">
			<!-- <div class="row justify-content-center"> -->
				<!-- <div class="col-md-7 col-lg-5"> -->
					<div class="login-wrap p-5 p-md-10" style="color:darkblue;background-color:aliceblue;" >
                        <div class="icon d-flex align-items-center justify-content-center">
							<svg width="200px" height="129px" viewBox="-4.08 -4.08 32.16 32.16" fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(1, 0, 0, -1, 0, 0)"><g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(1.4399999999999995,1.4399999999999995), scale(0.88)"><path transform="translate(-4.08, -4.08), scale(2.01)" fill="#7ed0ec" d="M9.166.33a2.25 2.25 0 00-2.332 0l-5.25 3.182A2.25 2.25 0 00.5 5.436v5.128a2.25 2.25 0 001.084 1.924l5.25 3.182a2.25 2.25 0 002.332 0l5.25-3.182a2.25 2.25 0 001.084-1.924V5.436a2.25 2.25 0 00-1.084-1.924L9.166.33z" strokewidth="0"></path></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Edit / Add_Plus_Square"> <path id="Vector" d="M8 12H12M12 12H16M12 12V16M12 12V8M4 16.8002V7.2002C4 6.08009 4 5.51962 4.21799 5.0918C4.40973 4.71547 4.71547 4.40973 5.0918 4.21799C5.51962 4 6.08009 4 7.2002 4H16.8002C17.9203 4 18.4801 4 18.9079 4.21799C19.2842 4.40973 19.5905 4.71547 19.7822 5.0918C20.0002 5.51962 20.0002 6.07967 20.0002 7.19978V16.7998C20.0002 17.9199 20.0002 18.48 19.7822 18.9078C19.5905 19.2841 19.2842 19.5905 18.9079 19.7822C18.4805 20 17.9215 20 16.8036 20H7.19691C6.07899 20 5.5192 20 5.0918 19.7822C4.71547 19.5905 4.40973 19.2842 4.21799 18.9079C4 18.4801 4 17.9203 4 16.8002Z" stroke="#000000" stroke-width="1.344" stroke-linecap="round" stroke-linejoin="round"></path> </g> </g></svg>
		      	        </div>
		      	        <strong><h3 style="font-weight:bold" class="text-center">Update Contact</h3></strong>

                Search Id :
	           <div class="form-group d-flex">
	             <input type="number" name="id" class="form-control rounded-left" placeholder="Name..." value="${contact.id}" readonly>
	           </div>

                Enter Name :
	           <div class="form-group d-flex">
	             <input type="text" name="name" class="form-control rounded-left" placeholder="Name..." value="${contact.name}" required ${mode}>
	           </div>
     

                Enter Contact No :
	           <div class="form-group d-flex">
	             <input type="text" name="contactNo" class="form-control rounded-left" placeholder="Contact No..." value="${contact.contactNo}" required ${mode}>
	           </div>
     

                Enter Contact No Informataion :
	           <div class="form-group d-flex">
	             <input type="text" name="contactNoInformataion" class="form-control rounded-left" placeholder="Contact No Informataion..." value="${contact.contactNoInformataion}" required ${mode}>
	           </div>
     

                Enter Designation :
	           <div class="form-group d-flex">
	             <input type="text" name="designation" class="form-control rounded-left" placeholder="Designation..." value="${contact.designation}" required ${mode}>
	           </div>
     

                Enter House No :
	           <div class="form-group d-flex">
	             <input type="text" name="houseNo" class="form-control rounded-left" placeholder="House No..." value="${contact.houseNo}" required ${mode}>
	           </div>
     

                Enter Colony :
	           <div class="form-group d-flex">
	             <input type="text" name="colony" class="form-control rounded-left" placeholder="Colony..." value="${contact.colony}" required ${mode}>
	           </div>
     

                Enter City :
	           <div class="form-group d-flex">
	             <input type="text" name="city" class="form-control rounded-left" placeholder="City..." value="${contact.city}" required ${mode}>
	           </div>
     

                Enter Sub District :
	           <div class="form-group d-flex">
	             <input type="text" name="subDistrict" class="form-control rounded-left" placeholder="Sub District..." value="${contact.subDistrict}" required ${mode}>
	           </div>
     

                Enter Pin Code :
	           <div class="form-group d-flex">
	             <input type="text" name="pinCode" class="form-control rounded-left" placeholder="Pin Code..." value="${contact.pinCode}" required ${mode}>
	           </div>
     

                Enter State :
	           <div class="form-group d-flex">
	             <input type="text" name="state" class="form-control rounded-left" placeholder="State..." value="${contact.state}" required ${mode}>
	           </div>
     

                Enter Dealer Type :
	           <div class="form-group d-flex">
	             <input type="text" name="dealerType" class="form-control rounded-left" placeholder="Dealer Type..." value="${contact.dealerType}" required ${mode}>
	           </div>
     

                Enter Dealer Visit :
	           <div class="form-group d-flex">
	             <input type="text" name="dealerVisit" class="form-control rounded-left" placeholder="Dealer Visit..." value="${contact.dealerVisit}" required ${mode}>
	           </div>
     

                Enter Dealer Visit Date :
	           <div class="form-group d-flex">
	             <input type="date" name="dealerVisitDate" class="form-control rounded-left" placeholder="Dealer Visit Date..." value="${contact.dealerVisitDate}" required ${mode}>
	           </div>
     

                Enter Company Visit :
	           <div class="form-group d-flex">
	             <input type="text" name="companyVisit" class="form-control rounded-left" placeholder="Company Visit..." value="${contact.companyVisit}" required ${mode}>
	           </div>
     

                Enter Company Visit Date :
	           <div class="form-group d-flex">
	             <input type="date" name="companyVisitDate" class="form-control rounded-left" placeholder="Company Visit Date..." value="${contact.companyVisitDate}" required ${mode}>
	           </div>
     

                Enter Existing Dealer :
	           <div class="form-group d-flex">
	             <input type="text" name="existingDealer" class="form-control rounded-left" placeholder="Existing Dealer..." value="${contact.existingDealer}" required ${mode}>
	           </div>
     

                Enter Call Detail Count :
	           <div class="form-group d-flex">
	             <input type="number" name="callDetailCount" class="form-control rounded-left" placeholder="Call Detail Count..." value="${contact.callDetailCount}" required ${mode}>
	           </div>
     

                Enter Discussion1 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion1" class="form-control rounded-left" placeholder="Discussion1..." value="${contact.discussion1}" required ${mode}>
	           </div>
     

                Enter Discussion2 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion2" class="form-control rounded-left" placeholder="Discussion2..." value="${contact.discussion2}" required ${mode}>
	           </div>
     

                Enter Discussion3 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion3" class="form-control rounded-left" placeholder="Discussion3..." value="${contact.discussion3}" required ${mode}>
	           </div>
     

                Enter Discussion4 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion4" class="form-control rounded-left" placeholder="Discussion4..." value="${contact.discussion4}" required ${mode}>
	           </div>
     

                Enter Discussion5 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion5" class="form-control rounded-left" placeholder="Discussion5..." value="${contact.discussion5}" required ${mode}>
	           </div>
     

                Enter Rate Issue :
	           <div class="form-group d-flex">
	             <input type="text" name="rateIssue" class="form-control rounded-left" placeholder="Rate Issue..." value="${contact.rateIssue}" required ${mode}>
	           </div>
     

                Enter Quality Issue :
	           <div class="form-group d-flex">
	             <input type="text" name="qualityIssue" class="form-control rounded-left" placeholder="Quality Issue..." value="${contact.qualityIssue}" required ${mode}>
	           </div>
     

                Enter Service Issue :
	           <div class="form-group d-flex">
	             <input type="text" name="serviceIssue" class="form-control rounded-left" placeholder="Service Issue..." value="${contact.serviceIssue}" required ${mode}>
	           </div>
     

                Enter Existing Dealer Company :
	           <div class="form-group d-flex">
	             <input type="text" name="existingDealerCompany" class="form-control rounded-left" placeholder="Existing Dealer Company..." value="${contact.existingDealerCompany}" required ${mode}>
	           </div>     
     
							<div style="display:flex" class="form-group">
								<button type="submit" style="flex:2; ; margin:10px" class="btn btn-primary rounded submit px-3">Update</button>
							</div>
	                </div>	         
				<!-- </div> -->
			<!-- </div> -->
