		...
		<div  class="container">
			<!-- <div class="row justify-content-center"> -->
	           ...
	           <div class="form-group d-flex">
                ...
                Enter House No :
	           <div class="form-group d-flex">
	             <input type="text" name="houseNo" class="form-control rounded-left" placeholder="House No..." > <!--required> -->
	           </div>
     

                Enter Colony :
	           <div class="form-group d-flex">
	             <input type="text" name="colony" class="form-control rounded-left" placeholder="Colony..." > <!--required> -->
	           </div>
     

                Enter City :
	           <div class="form-group d-flex">
	             <input type="text" name="city" class="form-control rounded-left" placeholder="City..." > <!--required> -->
	           </div>
     

                Enter Sub District :
	           <div class="form-group d-flex">
	             <input type="text" name="subDistrict" class="form-control rounded-left" placeholder="Sub District..." > <!--required> -->
	           </div>
     

                Enter Pin Code :
	           <div class="form-group d-flex">
	             <input type="text" name="pinCode" class="form-control rounded-left" placeholder="Pin Code..." > <!--required> -->
	           </div>
     

                Enter State :
	           <div class="form-group d-flex">
	             <input type="text" name="state" class="form-control rounded-left" placeholder="State..." > <!--required> -->
	           </div>

				<h4 class="text-center mb-4">Dealer Detail</h4>
     

                Enter Dealer Type :
	           <div class="form-group d-flex">
	             <input type="text" name="dealerType" class="form-control rounded-left" placeholder="Dealer Type..." > <!--required> -->
	           </div>
     

                Enter Dealer Visit :
	           <div class="form-group d-flex">
	             <input type="text" name="dealerVisit" class="form-control rounded-left" placeholder="Dealer Visit..." > <!--required> -->
	           </div>
     

                Enter Dealer Visit Date :
	           <div class="form-group d-flex">
	             <input type="date" name="dealerVisitDate" class="form-control rounded-left" placeholder="Dealer Visit Date..." > <!--required> -->
	           </div>
     

                Enter Company Visit :
	           <div class="form-group d-flex">
	             <input type="text" name="companyVisit" class="form-control rounded-left" placeholder="Company Visit..." > <!--required> -->
	           </div>
     

                Enter Company Visit Date :
	           <div class="form-group d-flex">
	             <input type="date" name="companyVisitDate" class="form-control rounded-left" placeholder="Company Visit Date..." > <!--required> -->
	           </div>
     

                Enter Existing Dealer :
	           <div class="form-group d-flex">
	             <input type="text" name="existingDealer" class="form-control rounded-left" placeholder="Existing Dealer..." > <!--required> -->
	           </div>
     

                Enter Call Detail Count :
	           <div class="form-group d-flex">
	             <input type="number" name="callDetailCount" class="form-control rounded-left" placeholder="Call Detail Count..." > <!--required> -->
	           </div>
     
				<h4 class="text-center mb-4">Discussions</h4>

                Enter Discussion1 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion1" class="form-control rounded-left" placeholder="Discussion1..." > <!--required> -->
	           </div>
     

                Enter Discussion2 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion2" class="form-control rounded-left" placeholder="Discussion2..." > <!--required> -->
	           </div>
     

                Enter Discussion3 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion3" class="form-control rounded-left" placeholder="Discussion3..." > <!--required> -->
	           </div>
     

                Enter Discussion4 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion4" class="form-control rounded-left" placeholder="Discussion4..." > <!--required> -->
	           </div>
     

                Enter Discussion5 :
	           <div class="form-group d-flex">
	             <input type="text" name="discussion5" class="form-control rounded-left" placeholder="Discussion5..." > <!--required> -->
	           </div>
     
				<h4 class="text-center mb-4">Issue Raised</h4>

                Enter Rate Issue :
	           <div class="form-group d-flex">
	             <input type="text" name="rateIssue" class="form-control rounded-left" placeholder="Rate Issue..." > <!--required> -->
	           </div>
     

                Enter Quality Issue :
	           <div class="form-group d-flex">
	             <input type="text" name="qualityIssue" class="form-control rounded-left" placeholder="Quality Issue..." > <!--required> -->
	           </div>
     

                Enter Service Issue :
	           <div class="form-group d-flex">
	             <input type="text" name="serviceIssue" class="form-control rounded-left" placeholder="Service Issue..." > <!--required> -->
	           </div>
     
				<!-- <h4 class="text-center mb-4">Other Detail</h4> -->

                Enter Existing Dealer Company :
	           <div class="form-group d-flex">
	             <input type="text" name="existingDealerCompany" class="form-control rounded-left" placeholder="Existing Dealer Company..." > <!--required> -->
	           </div>
     
     
							<div style="display:flex" class="form-group">
								<button type="submit" style="flex:2; ; margin:10px" class="btn btn-primary rounded submit px-3">Submit</button>
								<button type="reset" style="flex:1; ; margin:10px" class="btn btn-primary rounded submit px-3">Reset</button>
							</div>
	                </div>	         
				<!-- </div> -->
			<!-- </div> -->
